...
if (isset($_GET['sort'])) {
    ...
    switch ($sortOption) {
        ...
        case 'rent-price-desc':
            ...
            break;
        case 'buy-price-asc':
            $select_query .= " ORDER BY buy_price ASC";
            break;
        case 'buy-price-desc':
            $select_query .= " ORDER BY buy_price DESC";
            break;
        default:
...
<body>
    <div class="banner">
        <div class="navbar">
        <a href="../HTML/Home User.php"><img src="../IMAGES/RICH SABINIANS.png" class="logo"></a>
            <ul>
            ...
            <div class="filter-box" name="sizes[]" value=" data-state="blank"></div> ' . htmlspecialchars($size) . '
                    ...
                    <div class="right-column">
                        <div class="sort-container">
                            ...
                            <select id="buy-sort-options" onchange="sortProducts('buy')">
                                <option value="" disabled selected>Buy Price</option>
                                <option value="buy-price-asc">Low to High</option>
                                <option value="buy-price-desc">High to Low</option>
                            </select>
                        </div>
                                ...
                                <a href="Preview.php?id=<?php echo $row['id']; ?>" class="card-link">
                                    <div class="card">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p class="price"><b>Buy: ₱<?php echo number_format($row['buy_price'], 2); ?></b></p>
                                        </div>
                                    </div>
                                </a>
                            <?php } ?>
